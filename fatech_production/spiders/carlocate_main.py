...
class CarlocateMainSpider(MainSpider):
    """ Carlocate main spider which inherites MainSpider template """
    ...
    def __init__(self, **kwargs):
        ...
        super(CarlocateMainSpider, self).__init__(site=self.site, base_url=self.base_url)
